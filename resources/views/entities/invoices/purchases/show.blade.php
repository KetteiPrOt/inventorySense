    ...
    <div class="sm:flex mb-6">
        <div class="mb-4 sm:mb-0 sm:mr-12">
            ...
            <p>
                ...
                @if(!is_null($invoice->provider))
                    <a href="{{route('provider.show', $invoice->provider->id)}}" class="text-blue-400 underline">
    ...
    <div class="space-y-4">
        ...
        @else
            ...
            <form
                ...
                action="{{route('purchases.update', $invoice->id)}}" method="post"
            >
                @csrf
                @method('put')
