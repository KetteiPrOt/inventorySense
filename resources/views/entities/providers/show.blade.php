        ...
        <x-modal name="confirm-product-deletion" :show="$errors->isNotEmpty()" focusable>
            ...
            >
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Una vez que el proveedor sea eliminado se perderá <strong>por siempre y de forma irreversible</strong> toda su información. Además en lo registros ascociados de compras, ventas, reportes, e inventario se establecerá el proveedor como "Desconocido".
                </p>
